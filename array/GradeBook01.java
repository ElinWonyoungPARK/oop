...
public class Ex12GradeBook01 {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < scoreArray.length; i++) {
            ...
            // scoreArray의 i번 인덱스 배열의 0번째 인덱스는 국어점수이니 임시변수 korean 에 넣어주자
            int korean = scoreArray[i][0];
            
            // scoreArray의 i번 인덱스 배열의 0번째 인덱스는 영어점수이니 임시변수 english 에 넣어주자
            int english = scoreArray[i][1];
            
            // scoreArray의 i번 인덱스 배열의 0번째 인덱스는 수학점수이니 임시변수 math 에 넣어주자
