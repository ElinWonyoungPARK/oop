...
public class Ex08LottoNumbers {
    ...
    public static void main(String[] args) {
        ...
        // 이렇게 숫자가 있을경우
        // 1번 인덱스와 5번 인덱스는
        // 인덱스는 틀리지만 배열[인덱스]의 값이 같기때문에
        // 중복이 된다
        
        //따라서 우리는 2중 for문을 이용해서
        // i 와 j가 다르지만
        // lottoNumber[i]와 lottoNumbers[j]의 값이 같을때에는
        // lottoNumber[i]에 새로운 값을 넣어주고
        // 해당 값이 중복인지 아닌지 다시 체크하게 할 것이다.
        for(int i = 0; i < lottoNumbers.length; i++) {
